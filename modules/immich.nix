{ pkgs, ... }:
{
    ...
    systemd.services.immich-server = {
        ...
        after = [ "mnt-TrueNas\\x2dPhoto-nicoco.mount" "mnt-TrueNas\\x2dPhoto-share.mount" ];
        requires = [ "mnt-TrueNas\\x2dPhoto-nicoco.mount" "mnt-TrueNas\\x2dPhoto-share.mount" ];
        ...
        serviceConfig = {
            ...
            ReadWritePaths = [ "/mnt/TrueNas-Photo/share/immich" ];
        };
